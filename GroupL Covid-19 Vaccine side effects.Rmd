...
For this project, we explored two datasets -- tweets about Covid-19 vaccine and the reported side effects of the vaccine.
...
setweet <- read.csv("./data/tweet_side_effect.csv")
...
```{r include=FALSE}
load("./data/term_stemmed_side_effect.RData")
```
